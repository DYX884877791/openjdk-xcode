...
/**
 * SecureClassLoader扩展自ClassLoader，添加了从源码文件获取类定义的安全控制的支持，主要是新增了两个子类可覆写的方法，
 * 其中CodeSource用于保存源码文件相关的属性，如URL，代码签名，签名证书等，即CodeSource表示一个唯一的源码文件，ProtectionDomain表示一系列的安全控制的策略
