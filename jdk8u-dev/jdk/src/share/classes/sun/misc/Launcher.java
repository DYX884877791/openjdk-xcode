...
public class Launcher {
    ...
    /*
     * ExtClassLoader扩展自URLClassLoader，未改写父类的任何方法，重点关注其初始化方法：getExtClassLoader
    ...
    /**
     *  AppClassLoader扩展自URLClassLoader，同ExtClassLoader，未改写父类的任何方法，重点关注其初始化方法:getAppClassLoader
    ...
    static class AppClassLoader extends URLClassLoader {
        ...
        public static ClassLoader getAppClassLoader(final ClassLoader extcl)
            throws IOException
        {
            //读取系统属性，java.class.path默认情况下就是启动命令中的classpath选项的值，可比对Ideal的启动命令选项同该属性的值。
