...
public class URLClassPath {
    ...
    /**
     * Loader是URLClassPath定义的私有静态内部类，Loader提供在指定路径的资源包如jar包或者文件目录下查找指定名称的资源的能力
     * 即findResource和getResource两个方法，JarLoader表示jar包资源加载器，FileLoader表示文件目录的资源加载器，两者都是Loader的子类
     *
