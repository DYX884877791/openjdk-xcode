...
// _call_stub_entry的定义如下：类型为address，（实际的类型是unsigned char *）
// _call_stub_entry的初始化逻辑在hotspot/src/cpu/x86/vm/stubGenerator_x86_64.cpp文件下的generate_initial()函数中，调用链如下：
// JavaMain()                          java.c
